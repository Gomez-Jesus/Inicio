...
if (!function_exists('rosemary_woocommerce_theme_setup3')) {
	...
	function rosemary_woocommerce_theme_setup3() {
		...
		if (rosemary_exists_woocommerce()) {
			...
			add_action(    'woocommerce_shop_loop_subcategory_title',   'rosemary_woocommerce_shop_loop_subcategory_title', 9, 1);
		...
		if (rosemary_is_woocommerce_page()) {
			...
			if (rosemary_param_is_on(rosemary_get_custom_option('show_post_related'))) {
				...
				add_filter('woocommerce_related_products_args', 'rosemary_woocommerce_related_products_args');
			} else {
...
if ( !function_exists( 'rosemary_woocommerce_shop_loop_subcategory_title' ) ) {
	//Handler of the add_filter( 'woocommerce_shop_loop_subcategory_title', 'rosemary_woocommerce_shop_loop_subcategory_title' );
	function rosemary_woocommerce_shop_loop_subcategory_title($cat) {
...
if ( !function_exists( 'rosemary_woocommerce_template_loop_product_title' ) ) {
	// add_action( 'woocommerce_shop_loop_item_title',    'rosemary_woocommerce_template_loop_product_title', 10 );
	function rosemary_woocommerce_template_loop_product_title() {
